		...
		opts = {
			...
			default_component_configs = {
				...
				indent = {
					...
					with_markers = true,
					with_expanders = true,
					expander_collapsed = require("icons").folds.closed,
					expander_expanded = require("icons").folds.open,
				},
				icon = {
					folder_closed = require("icons").folders.closed,
					folder_open = require("icons").folders.open,
					folder_empty = require("icons").folders.empty,
					folder_empty_open = require("icons").folders.empty_open,
					use_filtered_colors = true,
					default = require("icons").files.default,
				},
				modified = { symbol = require("icons").files.modified },
				git_status = {
					symbols = {
						added = require("icons").git.add,
						deleted = require("icons").git.removed,
						modified = require("icons").git.modified,
						renamed = require("icons").git.renamed,
						untracked = require("icons").git.untracked,
						ignored = require("icons").git.ignored,
						unstaged = "", -- require("icons").git.unstaged,
						staged = require("icons").git.staged,
						conflict = require("icons").git.conflict,
					},
				},
			},
			commands = {
